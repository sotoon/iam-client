...
const (
	...
	// Third-party
	RouteThirdPartyBulkRefreshToken = "/workspace/{workspace_uuid}/third-parties/{third_party_uuid}/service-users/{service_user_uuid}/bulk-refresh-tokens"
	RouteThirdPartyAccessToken      = "/organizations/{organization_uuid}/third-parties/{third_party_uuid}/access-tokens"
